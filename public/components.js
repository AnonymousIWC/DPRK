...
(function () {
  ...
  window.DPRK = {
    ...
    TITLES: [
      ...
      // ── HEROIC GRADE ──
      { id: 'great-marshal',                     grade: 'Heroic',    gradeColour: '#3a0070', icon: '⚡', en: "Great Marshal of the Invincible Armed Forces & Guardian of the Socialist Flame",                ko: '무적의 조선인민군 대원수이며 사회주의 불꽃의 수호자',       desc: 'For the person who approaches every challenge with the composure of someone who has already won. They have not lost. Not once. The registry has checked.',                                                                                                    popular: false, price: 59 },
